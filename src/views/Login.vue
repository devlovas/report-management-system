  ...
  <div class='container'>
    ...
    <form class='loginRef' action='#' method='get'>
      ...
      <div class='inp-pasInput' :style='{border: `1px solid ${formStyle.border.pasInput}`}'>
        ...
        <input type="pasInput" v-model='loginForm.pasInput' @blur='onBlurOfpasInput' @focus='onFocusOfpasInput' :style='{color: formStyle.color.inputText.pasInput}' maxLength='15' placeholder='请输入密码'>
        <div class='extend-fun'>
