  ...
  <div class='container'>
    ...
    <form class='loginRef' action='#' method='get'>
      ...
      <div class='inp-account'>
        ...
        <input type="text" v-model='loginForm.account' @blur='onBlurOfAccount' @focus='onFocusOfAccount' @keyup='inputChange' maxLength='15' placeholder='请输入账号'>
        <div class='extend-fun'>
          <i class='del-icon' @click='loginForm.account = ""' :style='{visibility: iconStatus.visibility.delIconAcc, opacity: iconStatus.opacity.delIconAcc}'><svg t="1607691144114" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="12295" width="32" height="32"><path d="M512 64q190.016 4.992 316.512 131.488T960 512q-4.992 190.016-131.488 316.512T512 960q-190.016-4.992-316.512-131.488T64 512q4.992-190.016 131.488-316.512T512 64z m0 394.016l-104-104q-12-12-27.488-12t-27.008 11.488-11.488 27.008 12 27.488l104 104-104 104q-12 12-12 27.488t11.488 27.008 27.008 11.488 27.488-12l104-104 104 104q16 15.008 36.992 9.504t26.496-26.496-9.504-36.992L565.984 512l104-104q12-12 12-27.488t-11.488-27.008-27.008-11.488-27.488 12z" p-id="12296" fill="#e6e6e6"></path></svg></i>
      ...
      <div class='inp-password'>
        ...
        <input type="password" v-model='loginForm.password' @blur='onBlurOfPassword' @focus='onFocusOfPassword' maxLength='15' placeholder='请输入密码'>
        <div class='extend-fun'>
          <i class='del-icon' @click='loginForm.password = ""' :style='{visibility: iconStatus.visibility.delIconPas, opacity: iconStatus.opacity.delIconPas}'><svg t="1607691144114" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="12295" width="32" height="32"><path d="M512 64q190.016 4.992 316.512 131.488T960 512q-4.992 190.016-131.488 316.512T512 960q-190.016-4.992-316.512-131.488T64 512q4.992-190.016 131.488-316.512T512 64z m0 394.016l-104-104q-12-12-27.488-12t-27.008 11.488-11.488 27.008 12 27.488l104 104-104 104q-12 12-12 27.488t11.488 27.008 27.008 11.488 27.488-12l104-104 104 104q16 15.008 36.992 9.504t26.496-26.496-9.504-36.992L565.984 512l104-104q12-12 12-27.488t-11.488-27.008-27.008-11.488-27.488 12z" p-id="12296" fill="#e6e6e6"></path></svg></i>
...
export default {
  ...
  setup () {
    ...
    function inputChange () {
      /**
       * @description: Account input 只能以数字形式输入
       * @return void
       */

      const lForm = state.loginForm
      lForm.account = lForm.account.replace(/[^\d]/g, '')
    }
